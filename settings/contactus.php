  ...
  <div class="container">
    <div class="form">
      <div class="contact-info">
        ...
        <p class="text">
          "Get in touch with us for any questions or support. Our friendly customer service team is available 24/7 to assist you. Fill out the contact form or use the provided information to reach us."<br> We will reply within 24 hours.
        </p>

        <div class="info">
          <div class="information">
            <img src="../assets/image/location.png" class="icon" alt="" />
            <p>Purulia, West Bengal 723101</p>
          </div>
          <div class="information">
            <img src="../assets/image/email.png" class="icon" alt="" />
            <p>support@messfinder.com</p>
          </div>
          <div class="information">
            <img src="../assets/image/phone.png" class="icon" alt="" />
            <p>+91 6296055715</p>
          </div>
        </div>
